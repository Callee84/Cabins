...
urlpatterns = [
    ...
    path('guestbook/edit<int:pk>', views.EditGuestPost.as_view(), name='edit_guest_post'),
    path('guestbook/deleted/<int:pk>', views.DeleteGuestPost.as_view(), name='deleted_guest_post'),
]
